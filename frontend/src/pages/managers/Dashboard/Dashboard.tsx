...
const Dashboard = () => {
        ...
        const fetchAll = async () => {
            ...
            try {
                ...
                try {
                    ...
                    const newOrders = orderList.filter((o: any) => o.status === 'pending' && !o.deleted);
                    setOrderCount(newOrders.length);
                    const revenue = orderList
                        .filter((o: any) => !o.deleted)
                        .reduce((sum: number, o: any) => sum + (o.totalPay || 0), 0);
                    setTotalRevenue(revenue);
                } catch {
                    // Order endpoint may not exist yet
                    setOrderCount(0);
                    setTotalRevenue(0);
                }
            } finally {
    ...
    const Metric = [
        ...
        },
        {
            ...
            name: "New Orders",
            number: loading ? "..." : orderCount.toLocaleString()
        },
        {
